//import Alogrithm.BinarySearch.Solution;
...
//        moveZeros.partitionArrayIntoTwo(a,10);
//        System.out.print(Arrays.toString(a));
...
public class Main
{
    ...
    {
        String[] arr = {"123","243","qweqw","hghfgh"};
        String test = "this is a test of java reflection";
